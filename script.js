document.addEventListener("DOMContentLoaded", () => {
    ...
    const message = "Sengaja ngucapinnya malam-malam... Biar orang-orang berlomba jadi yang pertama menyambut hari bahagiamu, tapi izinkan aku jadi yang terakhir menutupnya. Terima kasih sudah jadi partner yang luar biasa hebat, sabar, dan selalu ngasih energi terbaik walau situasinya kadang nggak ramah. Aku saksi betapa besar dedikasimu. Semoga di usia ini, Kak Anisa menemukan ketenangan hati, dikelilingi hal-hal yang menghargai value-mu, dan bahagia seutuhnya. You deserve it, Kak. Selamat istirahat ya.";
